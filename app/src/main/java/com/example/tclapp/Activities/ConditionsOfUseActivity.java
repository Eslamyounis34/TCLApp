...
public class ConditionsOfUseActivity extends AppCompatActivity {

    Toolbar toolbar;
    TextView toolbarTitle,conditionsTx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conditionsTx=findViewById(R.id.conditions_text);

        toolbarTitle.setText("Condition Of Use");

        conditionsTx.setText("1. Contents of the online offer\n" +
